      ...
      <section className="relative mx-auto max-w-5xl">
        <div className="mb-8">
          ...
          <p className="mt-4 text-slate-400 font-light max-w-md leading-relaxed">
            Plan workouts, assign them to players, and track development over
            time.
          </p>
        </div>
        ...
        <div className="grid gap-3 md:grid-cols-3 mb-8">
          <Link
            href="/players"
            className="group relative rounded-xl bg-white/[0.04] border border-white/[0.08] p-5 hover:bg-white/[0.07] hover:border-white/[0.15] hover:-translate-y-0.5 transition-all duration-200 overflow-hidden"
          >
            ...
            <h2
              className="text-lg font-bold uppercase tracking-wide text-slate-100 mb-1"
              style={{ fontFamily: "'Barlow Condensed', sans-serif" }}
            >
              Players
            </h2>
            <p className="text-xs text-slate-500 leading-relaxed mb-4">
              Manage player profiles, positions, and individual development
              goals.
            </p>
