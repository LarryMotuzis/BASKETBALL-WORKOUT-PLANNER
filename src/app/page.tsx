  ...
  const [playerCount, workoutCount, drillCount, thisWeekCount] =
    await Promise.all([
      ...
      prisma.workout.count({
        where: { userId, workoutDate: { gte: oneWeekAgo } },
      }),
    ]);
    ...
    <main className="min-h-screen bg-[#0a0e1a] p-8 relative overflow-hidden">
      ...
      <section className="relative mx-auto max-w-5xl">
        ...
        <div className="grid gap-3 md:grid-cols-3 mb-8">
          <Link
            href="/players"
            className="group relative rounded-xl bg-white/4 border border-white/8 p-5 hover:bg-white/[0.07] hover:border-white/15 hover:-translate-y-0.5 transition-all duration-200 overflow-hidden"
          >
            ...
            <h2 className="text-lg font-bold uppercase tracking-wide text-slate-100 mb-1" style={{ fontFamily: "'Barlow Condensed', sans-serif" }}>
              Players
            </h2>
            <p className="text-xs text-slate-500 leading-relaxed mb-4">
              Manage player profiles, positions, and individual development goals.
            </p>
          ...
          >
            ...
            <p className="text-xs text-slate-500 leading-relaxed mb-4">
              Browse and manage your drill library by skill category.
            </p>
        ...
        <div className="flex items-center gap-3">
          <Link
            href="/workouts"
            className="inline-flex items-center gap-2 bg-orange-500 hover:bg-orange-600 active:scale-95 text-white text-sm font-bold uppercase tracking-widest px-5 py-2.5 rounded-lg transition-all duration-150"
            style={{ fontFamily: "'Barlow Condensed', sans-serif" }}
          >
          ...
          <Link
            href="/players"
            className="inline-flex items-center gap-2 text-slate-400 hover:text-slate-100 border border-white/10 hover:border-white/25 text-sm font-semibold uppercase tracking-wider px-5 py-2.5 rounded-lg transition-all duration-150"
            style={{ fontFamily: "'Barlow Condensed', sans-serif" }}
          >
            Add player
          </Link>
