...
import { signInWithCredentials, signInWithGitHub, signInWithGoogle } from "@/actions/auth-actions";
    ...
    <div className="rounded-xl bg-white/4 border border-white/8 p-6 space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        <form action={signInWithGoogle}>
          <button
            type="submit"
            className="w-full flex items-center justify-center gap-2 rounded-lg bg-white hover:bg-gray-100 px-4 py-2.5 text-gray-800 text-sm font-semibold transition-colors"
          >
        ...
        <form action={signInWithGitHub}>
          <button
            type="submit"
            className="w-full flex items-center justify-center gap-2 rounded-lg bg-slate-800 hover:bg-slate-700 border border-white/10 px-4 py-2.5 text-slate-100 text-sm font-semibold transition-colors"
          >
